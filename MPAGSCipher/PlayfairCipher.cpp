...
/*
PlayfairCipher::PlayfairCipher(const int &cipherKey, CipherMode cipherMode): key_{0}, cipherMode_{CipherMode::encrypt} {
key_ = cipherKey;
cipherMode_ = cipherMode;
}
*/
PlayfairCipher::PlayfairCipher(std::string &cipherKey): key_{0} {
key_ = cipherKey;
}
